...
abstract class StockSync_Distributor {
	 ...
	 * the link text is generated by replacing a leading "A - Oferta " prefix with "Wina ",
	 * preserving the rest of the category name. Otherwise falls back to the cached
	 * distributor-level category,
