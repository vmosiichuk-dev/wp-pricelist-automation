...
class StockSync_Change_Logger {
    ...
    public function log(array $data) {
        ...
        $wpdb->insert($this->table_name, [
            ...
            'old_name'         => sanitize_text_field($record['old_name']),
            'new_name'         => sanitize_text_field($record['new_name']),
            'old_slug'         => sanitize_text_field($record['old_slug']),
            'new_slug'         => sanitize_text_field($record['new_slug']),
