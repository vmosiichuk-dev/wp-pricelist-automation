...
<div class="stock-sync-panel">
    ...
    <div class="stock-info-banner">
        <div class="stock-info-content">
            <h2 class="stock-info-title"><?php _e('Distributor Sync', 'stock-sync'); ?></h2>
            <div class="stock-info-text">
                <ul>
                    <li><svg class="stock-info-icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg><?php _e('Upload a distributor price list and map products automatically', 'stock-sync'); ?></li>
                    <li><svg class="stock-info-icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg><?php _e('Preview availability changes before applying them', 'stock-sync'); ?></li>
                    <li><svg class="stock-info-icon" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg><?php _e('Keep your catalog in sync with one click', 'stock-sync'); ?></li>
                </ul>
            </div>
        </div>
    ...
    <div class="stock-stepper" id="stock-stepper">
        <div class="stock-step active" data-step="1">
            ...
            <span class="stock-step-label"><?php _e('Upload', 'stock-sync'); ?></span>
        </div>
        <div class="stock-step pending" data-step="2">
            <span class="stock-step-icon">2</span>
            <span class="stock-step-label"><?php _e('Map', 'stock-sync'); ?></span>
        </div>
        <div class="stock-step pending" data-step="3">
            <span class="stock-step-icon">3</span>
            <span class="stock-step-label"><?php _e('Preview', 'stock-sync'); ?></span>
        </div>
        <div class="stock-step pending" data-step="4">
            <span class="stock-step-icon">4</span>
            <span class="stock-step-label"><?php _e('Apply', 'stock-sync'); ?></span>
        </div>
    </div>
    ...
    <div id="sync-step-upload">
        <div class="stock-card">
            <h2 class="stock-card-title"><?php _e('Upload Price List', 'stock-sync'); ?></h2>
            <p class="stock-card-desc"><?php _e('Drag and drop your .xlsx file or click to browse. Unmapped products will be shown for review before syncing.', 'stock-sync'); ?></p>
            ...
            <form id="stock-sync-form" method="post" enctype="multipart/form-data" class="stock-upload-form">
                ...
                <div class="stock-upload-stack">
                    ...
                    <details class="stock-upload-options">
                        <summary>
                            <span><?php _e('Advanced options', 'stock-sync'); ?></span>
                        ...
                        <div class="stock-advanced-inner">
                            <label for="header_label_ref"><?php _e('Reference column', 'stock-sync'); ?></label>
                            ...
                            <label for="header_label_avail"><?php _e('Availability column', 'stock-sync'); ?></label>
    ...
    <div id="sync-step-preview" style="display:none;">
        <div class="stock-card">
            ...
            <h2 class="stock-card-title"><?php _e('Sync Preview', 'stock-sync'); ?></h2>
            <p class="stock-card-desc"><?php _e('Review the products that will be updated.<br>Uncheck any you want to exclude, then apply the sync.', 'stock-sync'); ?></p>
    ...
    <div id="stock-sync-results" class="stock-results" style="display:none;">
        <div class="stock-card">
            ...
            <h2 class="stock-card-title" id="stock-sync-results-title"><?php _e('Sync Results', 'stock-sync'); ?></h2>

            <div class="stock-stat-grid">
                <div class="stock-stat-item">
                    <div class="stock-stat-value" id="res-total">0</div>
                    <div class="stock-stat-label"><?php _e('Total Processed', 'stock-sync'); ?></div>
                </div>
                <div class="stock-stat-item success">
                    <div class="stock-stat-value" id="res-updated">0</div>
                    <div class="stock-stat-label" id="res-updated-label"><?php _e('Updated', 'stock-sync'); ?></div>
                </div>
                <div class="stock-stat-item warning">
                    <div class="stock-stat-value" id="res-notfound">0</div>
                    <div class="stock-stat-label"><?php _e('Not Found', 'stock-sync'); ?></div>
                </div>
                <div class="stock-stat-item warning">
                    <div class="stock-stat-value" id="res-errors">0</div>
                    <div class="stock-stat-label"><?php _e('Errors', 'stock-sync'); ?></div>
                </div>
            </div>
